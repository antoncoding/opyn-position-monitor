...
export function EthOptionList({ isInitializing, entries, showExpired, goToToken, typeText }: { isInitializing:Boolean, typeText: string, entries: types.ETHOption[], showExpired: boolean, goToToken: Function }) {
